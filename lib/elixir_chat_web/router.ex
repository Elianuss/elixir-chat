defmodule ElixirChatWeb.Router do
  ...
  scope "/", ElixirChatWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{ElixirChatWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", ElixirChatWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{ElixirChatWeb.UserAuth, :ensure_authenticated}] do
      live "/users/settings", UserSettingsLive, :edit
      live "/users/settings/confirm_email/:token", UserSettingsLive, :confirm_email
      live "/chat", ChatMain
      live "/chat/:id", ChatMain
    end
  end
  ...
  scope "/", ElixirChatWeb do
    ...
    live_session :current_user,
      on_mount: [{ElixirChatWeb.UserAuth, :mount_current_user}] do
